...
namespace Editoria.Infrastructure.Migrations
{
    ...
    [Migration("20250311220304_AddTablesAndSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Editoria.Domain.Entities.ArticleTag", b =>
                {
                    b.Property<int>("ArticleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Editoria.Domain.Entities.Editor", b =>
                {
            ...
            modelBuilder.Entity("Editoria.Domain.Entities.Issue", b =>
                {
                    b.Property<int>("IssueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            IssueId = 4,
                            Circulation = 3500,
                            Information = "Поражающие новости",
                            IsActive = true,
                            NewspaperId = 4,
            ...
            modelBuilder.Entity("Editoria.Domain.Entities.Newspaper", b =>
                {
                    b.Property<int>("NewspaperId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Editoria.Domain.Entities.Tag", b =>
                {
                    b.Property<int>("TagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            TagId = 1,
                            Description = "Новости, законы, реформы",
                            Name = "Политика",
                            Popularity = 5
                        },
                        new
                        {
                            TagId = 2,
                            Description = "Журналистика, СМИ, соцсети",
                        ...
                        {
                            TagId = 3,
                            Description = "Манга, сериалы, культура",
                            Name = "Аниме",
                            Popularity = 3
                        },
                        new
                        {
                            TagId = 4,
                            Description = "Мышление, идеи, мировоззрение",
                            Name = "Философия",
                            Popularity = 2
                        },
                        new
                        {
                            TagId = 5,
                            Description = "Код, алгоритмы, технологии",
                            Name = "Программирование",
                            Popularity = 5
                        },
                        new
                        ...
                        {
                            TagId = 7,
                            Description = "Наука, обучение, курсы",
                            Name = "Образование",
                            Popularity = 3
                        },
                        new
                        {
                            TagId = 8,
                            Description = "Видеоигры, индустрия, развлечения",
                            Name = "Игры",
                            Popularity = 4
                        },
                        new
                        {
                            TagId = 9,
                            Description = "ИИ, инновации, тренды",
                            Name = "Будущее технологий",
                            Popularity = 5
                        });
                });

            modelBuilder.Entity("Editoria.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Editoria.Domain.Entities.Advertisement", b =>
                {
                    b.HasOne("Editoria.Domain.Entities.Issue", "Issue")
            ...
            modelBuilder.Entity("Editoria.Domain.Entities.ArticleTag", b =>
                {
                    ...
                    b.HasOne("Editoria.Domain.Entities.Tag", "Tag")
                        .WithMany("ArticleTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Editoria.Domain.Entities.Issue", b =>
                {
                    b.HasOne("Editoria.Domain.Entities.Newspaper", "Newspaper")
                        .WithMany("Issues")
            ...
            modelBuilder.Entity("Editoria.Domain.Entities.Newspaper", b =>
                {
                    b.HasOne("Editoria.Domain.Entities.Editor", "Editor")
                        .WithOne("Newspaper")
                        .HasForeignKey("Editoria.Domain.Entities.Newspaper", "EditorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
