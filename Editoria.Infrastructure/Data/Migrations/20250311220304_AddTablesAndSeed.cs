    ...
    public partial class AddTablesAndSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Новости, законы, реформы", "Политика", 5 },
                    { 2, "Журналистика, СМИ, соцсети", "Медиа и информация", 4 },
                    { 3, "Манга, сериалы, культура", "Аниме", 3 },
                    { 4, "Мышление, идеи, мировоззрение", "Философия", 2 },
                    { 5, "Код, алгоритмы, технологии", "Программирование", 5 },
                    { 6, "Фитнес, питание, медицина", "Здоровье", 4 },
                    { 7, "Наука, обучение, курсы", "Образование", 3 },
                    { 8, "Видеоигры, индустрия, развлечения", "Игры", 4 },
                    { 9, "ИИ, инновации, тренды", "Будущее технологий", 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, 4, "Новая жизнь", "Краснодар", "Еженедельная" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, 3500, "Поражающие новости", true, 4, new DateTime(2024, 12, 4, 0, 0, 0, 0, DateTimeKind.Unspecified) },
